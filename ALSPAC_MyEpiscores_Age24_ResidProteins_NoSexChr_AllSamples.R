...
PenRegFun <- function(ARIESDNAm, VarMatch, Age, trainsplit=0.8){
  ...
  for (protein in ProteinList){
   ...
   #  )
    ...
    write.csv(Coeftable,"Age24ResidProtNoSexChrCoeftabletest.csv")
    #write.csv(Testtable,"Age9ResidProtNoSexChrCpGtabletest.csv")
    write.csv(Traintable,"Age24TrainResults.csv")
    write.csv(CVTraintable,"Age24CVTrainResults.csv")
...
save(Age24PenReg, file = 'PenRegAge24ResidProtNoSexChr_FullSamples.Rdata')
