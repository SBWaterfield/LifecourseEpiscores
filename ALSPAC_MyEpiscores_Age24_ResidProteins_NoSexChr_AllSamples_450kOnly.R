...
PenRegFun <- function(ARIESDNAm, VarMatch, Age, trainsplit=0.8){
  ...
  for (protein in ProteinList){
   ...
   #  )
    ...
    write.csv(Coeftable,"Age24ResidProtNoSexChrCoeftabletest450k.csv")
    #write.csv(Testtable,"Age9ResidProtNoSexChrCpGtabletest.csv")
    write.csv(Traintable,"Age24TrainResults450k.csv")
...
Age24PenReg <- PenRegFun(TwentyFourDNAm, Var24_TwentyFourDNAm, '_F24', trainsplit=1.0)
save(Age24PenReg, file = 'PenRegAge24ResidProtNoSexChr_FullSamples450K.Rdata')
